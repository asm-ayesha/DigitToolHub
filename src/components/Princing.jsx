...
const Princing = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto my-20 px-4 md:px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
                ...
                {/* card 2 */}
                <div className={`relative rounded-lg p-5 space-y-4 flex flex-col justify-between min-h-100 
                    ${activeCard === 'pro' ? 'bg-linear-to-r from-blue-900 to-purple-600' : 'bg-base-300 '}`}>

                    {/*  Badge */}
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-linear-to-r from-pink-500 to-purple-600 text-white text-xs px-4 py-1 rounded-full animate-bounce">
                        Most Popular
                    </span>
